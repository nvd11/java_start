 ...
 *
 */
public class TestStateMachine extends AbstractStateMachine {

	/**
	 * State Machine uses this scmxml config file
	 */
	private static final String SCXML_CONFIG_ATM_STATUS = "../Test.xml";
	...
	public TestStateMachine() {
        	super(TestStateMachine.class.getClassLoader().getResource(SCXML_CONFIG_ATM_STATUS));
	}
	...
	public void firePreDefinedEvent(TestEnum eventEnum){
